...
definition P6_1_inv where "P6_1_inv t b_0 b_1 t1_0 A1 A2 A3 A4_1 s \<equiv> (((always_inv (\<lambda> r2 r1 . ((weak_previous (\<lambda> r4 r3 . (dual_since t (\<lambda> r6 r5 . (\<not> (A2 r5))) (\<lambda> r6 r5 . (\<not> (A1 r5))) r4 r3)) r2 r1) \<or> ((\<not> (A3 r1)) \<or> (A4_1 r2 r1)))) s) \<and> (b_1 s --> (previous_inv (\<lambda> r4 r3 . (dual_since t (\<lambda> r6 r5 . (\<not> (A2 r5))) (\<lambda> r6 r5 . (\<not> (A1 r5))) r4 r3)) s))) \<and> (b_0 s --> (dual_since_inv t t1_0 (\<lambda> r6 r5 . (\<not> (A2 r5))) (\<lambda> r6 r5 . (\<not> (A1 r5))) s)))"
  ...
  subgoal premises prems1
    ...
    subgoal premises prems2
      ...
      apply(erule impE)
       apply assumption
      subgoal premises prems3
        apply(insert prems3(1,4))
        apply(rule pastinv)
         apply assumption
        apply(rule dual_since_L7)
         apply assumption
        apply(erule conjE)
        apply(rule conjI)
         apply assumption
        apply(rotate_tac 1)
        apply(match premises in p[thin]: _ \<Rightarrow> \<open>succeed\<close>)
        apply(rotate_tac 1)
        apply(erule disjE)
         apply(rule disjI1)
         apply assumption
        apply(rule disjI2)
        apply(prove einvs: prems1(3))
...
definition P6_2_inv where "P6_2_inv t b_0 b_1 w_0 t1_0 A1 A2 A3 A4_1 A5_1 s \<equiv> (((always_inv (\<lambda> r2 r1 . ((weak_previous (\<lambda> r4 r3 . (dual_since t (\<lambda> r6 r5 . (\<not> (A2 r5))) (\<lambda> r6 r5 . (\<not> (A1 r5))) r4 r3)) r2 r1) \<or> ((\<not> (A3 r1)) \<or> (weak_until_inv w_0 A4_1 A5_1 r2 r1)))) s) \<and> (b_1 s --> (previous_inv (\<lambda> r4 r3 . (dual_since t (\<lambda> r6 r5 . (\<not> (A2 r5))) (\<lambda> r6 r5 . (\<not> (A1 r5))) r4 r3)) s))) \<and> (b_0 s --> (dual_since_inv t t1_0 (\<lambda> r6 r5 . (\<not> (A2 r5))) (\<lambda> r6 r5 . (\<not> (A1 r5))) s)))"
