...
definition always where "always A (s::state) s1 \<equiv>
...
lemma always_einv2req[elims]: "always_inv A' s  \<Longrightarrow> toEnvP s \<Longrightarrow> always_imp s (A' s) (A s) \<Longrightarrow> always A s s"
